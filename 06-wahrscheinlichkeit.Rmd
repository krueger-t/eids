...
```{r muenze, echo=TRUE, fig.align='center', fig.cap='Simulation von 1000 Münzwürfen und die Entwicklung der relativen Häufigkeit der Merkmalsausprägung Zahl. Wir sehen, dass sich die relative Häufigkeit mit zunehmender Anzahl Münzwürfe dem erwarteten Wert 0.5 annähert. Den Grenzwert der relativen Häufigkeit wenn die Anzahl der Münzwürfe gegen unendlich geht nennen wir Wahrscheinlichkeit.', out.width='80%'}
