...
1. Der Vorlesung _Einführung in die Statistik_ mit [Tobias Krüger](https://www.iri-thesys.org/people/kruegertobias) (regelmäßiges ZOOM-Treffen, montags 11:00 - 12:30, s. Moodle link)
2. Der Vorlesung _Einführung in die Geographie_ mit [Christoph Schneider](https://www.geographie.hu-berlin.de/de/Members/schneider_christoph) und [Henning Nuissl](https://www.geographie.hu-berlin.de/de/Members/nuissl_henning)
...
Das vorliegende Skript ist Grundlage der Vorlesung _Einführung in die Statistik_ und dient der theoretischen Vorbereitung der PC-Übung _Statistische Datenverarbeitung_. Organisatorisches dazu [weiter unten](#orga).
...
Lesen Sie bitte Kapitel 2.3 [@zimmermann2014] für konkrete Anwendungsbeispiele der Statistik in der Geographie.
...
Der prinzipielle Lernmodus in diesem digitalen Semester ist das **Lesen** von Kapiteln aus dem vorliegenden Skript und aus zwei Lehrbüchern [@zimmermann2014; @mittag2016]. Dazu gibt es jede Woche ein kleines **Quiz** auf Moodle. Diese werden automatisch bewertet und sind Voraussetzung für den Erhalt der 3 Leistungspunkte der Vorlesung _Einführung in die Statistik_. In der **Vorlesung** jeden Montag besteht die Möglichkeit, Fragen zu klären und den Stoff der vorherigen Woche zu diskutieren. Die Vorlesung findet über ZOOM statt, s. permanenter Link auf Moodle.
...
Die Modulabschlussprüfung ist dieses Jahr eine sogenannte **take-home Klausur**, die Sie - voraussichtlich in der 1. Semesterferienwoche - zu Hause in einem vorgegeben Zeitrahmen selbständig bearbeiten. Ein Nachholtermin findet voraussichtlich in der letzten Semesterferienwoche statt. Die Anmeldung erfolgt gegen Semesterende über AGNES bei Frau Schwedler. Die take-home Klausur wird stark an die Übungen und Hausaufgaben angelehnt sein. Außerdem wird es ein paar Fragen über Moodle geben - ähnlich der regelmäßigen Quizze. Insgesamt werden sich \(\frac{5}{6}\) der zu erreichenden Punktzahl auf _Einführung in die Statistik_ beziehen und \(\frac{1}{6}\) auf _Einführung in die Geographie_.
