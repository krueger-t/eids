...
```{r qqentfernung, echo=TRUE, fig.align='center', fig.cap='Links: QQ-Plot der Entfernungsdaten. Wie wir in Kapitel \\@ref(haeufigkeit) und Kapitel \\@ref(verteilungen) gesehen haben sind die Originaldaten rechtsschief, was wir an dem nach oben gewölbten QQ-Plot sehen (vgl. Abbildung \\@ref(fig:qqvariation)). Eine Lognormalverteilung passte hier ganz gut. Rechts: QQ-Plot der log-transformierten Entfernungsdaten. Hier passt die Normalverteilung besser. Die Verteilung der Daten ist jedoch steiler als eine Normalverteilung (flachere Flanken), was sich in der leichten S-Kurve zeigt (vgl. Abbildung \\@ref(fig:qqvariation)); ausserdem ist der eine Extremwert unten links sichtbar.', fig.show='hold', out.width='50%'}
