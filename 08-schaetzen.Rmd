...
Die deskriptive Statistik wird uns die nächsten sechs Wochen beschäftigen. Nach diesem Kapitel zu **Schätzen von Verteilungsparametern** gibt es drei Kapitel zu **statistischen Tests** (Kapitel \@ref(ttest)-\@ref(chi2testkstest)) und abschließend Kapitel \@ref(regression) zu **linearer Regression**, das wir über zwei Wochen lesen werden. In Kapitel \@ref(regression) werden viele Lehrveranstaltungsinhalte zusammen kommen - also bleiben Sie dran.
