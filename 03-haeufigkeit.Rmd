...
```{r echo=TRUE}
# reisedat$x aufsteigend ordnen und ausgeben
sort(reisedat$x)
...
h <- hist(reisedat$x/1000, breaks = seq(0, 55, 5), plot = FALSE)
...
# Klassenbreite 5km
hist(reisedat$x/1000, breaks = seq(0, 60, 5),
     main = "", xlab = "Entfernung (km)", 
     ylab = "absolute Häufigkeit")
# Klassenbreite 10km
hist(reisedat$x/1000, breaks = seq(0, 60, 10),
     main = "", xlab = "Entfernung (km)", 
     ylab = "absolute Häufigkeit")
# Klassenbreite 20km
hist(reisedat$x/1000, breaks = seq(0, 60, 20),
     main = "", xlab = "Entfernung (km)", 
     ylab = "absolute Häufigkeit")
```
