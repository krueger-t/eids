...
Das ist eine ungeordnete Reihe von 77 Datenpunkten, den sogenannten **Rohdaten**.
...
# absolute Häufigkeiten bestimmen für Klassen von 0 bis 75km, mit Breite 5km
hist(reisedat$distanz, breaks = seq(0, 75, 5),
...
Interpretation: Der ersten Balken z.B. geht bis knapp über 0.1, d.h. etwas mehr als 10% der Entfernungsdaten haben Werte zwischen 0 und 5km. Wenn wir uns das Histogramm der absoluten Häufigkeiten weiter oben anschauen, dann sehen wir, dass das 9 von 77 Datenpunkten sind.
...
Die Häufigkeiten der Klassen sind hier kumuliert aufsummiert, d.h. der letzte Balken ganz rechts hat die absolute Höhe 77, die Gesamtzahl der Datenpunkte $n$, bzw. die relative Höhe 1 (100%). Sehen die dazu auch das Beispiel in @zimmermann2014, Tabelle 3.10 auf Seite 87.
...
Bei "künstlichen" Klassen wie in unserem Beispiel wird typischerweise die Mitte der häufigsten Klasse angegeben. Sie sehen also, der Modus ist in diesem Fall abhängig von der gewählten Klassifizierung und nicht eindeutig. In der obigen Darstellung sehen wir außerdem weitere lokale Maxima bei $37.5$, $52.5$ und $72.5$, es handelt sich also in dieser Klassifizierung um eine **multimodale** Verteilung - eine Verteilung mit mehreren Modi. Der Sonderfall der multimodalen Verteilung wäre die **bimodale** Verteilung, die zwei lokale Maxima hat.
