...
Im obigen Histogramm der Entfernungsdaten sehen wir außerdem weitere lokale Maxima bei $37.5$, $52.5$ und $72.5$, es handelt sich also in dieser Klassifizierung um eine **multimodale** Verteilung - eine Verteilung mit mehreren Modi. Der Sonderfall der multimodalen Verteilung wäre die **bimodale** Verteilung, die zwei lokale Maxima hat.
