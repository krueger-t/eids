...
```{r tegelh, echo=FALSE, fig.align='center', fig.cap='Kontingenztabelle zum Abstimmungsverhalten im Volksentscheid Tegel 2017 unterteilt nach Bezirk. <br><small> Quelle: https://www.wahlen-berlin.de/wahlen/BU2017/afspraes/ve/index.html. </small>', out.width='85%'}
...
Bei perfekter negativer Rangkorrelation ist $r_s=-1$. Bei perfekter positiver Rangkorrelation ist $r_s=1$. Wenn keine Rangkorrelation vorliegt ist $r_s=0$.
...
plot(reisedat$x / 1000, reisedat$t, 
