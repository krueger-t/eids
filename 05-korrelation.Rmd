...
Die Verfahren sind unterschiedlich für nominalskalierte, ordinalskalierte und metrische Merkmale. Wir werden diese jetzt nacheinander einführen.

Die Themen können Sie in @mittag2016, Kapitel 8 und 9 vertiefen.
...
**Aufgabe:** _Uberlegen Sie kurz, wie stark die Korrelation hier sein wird. (Auflösung weiter unten.)_
...
```{r echo=TRUE}
cor(dat$x, dat$t, use="complete.obs", method="pearson")
```
