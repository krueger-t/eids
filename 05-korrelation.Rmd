...
An dieser Stelle fällt das Wertepaar (0,40) oben links auf. Hierbei handelt es sich wahrscheinlich um die Person, die garnicht in Berlin wohnt. Anstatt "0" wollen wir hier aber einen fehlenden Wert, der in _R_ mit "NA" markiert wird, da diese Frage auf die Person garnicht zutraf. Darstellungen wie diese sind enorm hilfreich für die Überprüfung der Daten!

Ersetzen wir also "0" mit "NA" und plotten erneut:
```{r echo=TRUE}
# 0 mit NA ersetzen
