...
In Kapitel \@ref(wahrscheinlichkeit) haben wir gesehen, dass alle $36$ Elementarereignisse zweier Würfelwürfe $\omega=(1;1),(1;2),\ldots,(6;6)$ (vgl. Abbildung \@ref(fig:wuerfel2)) die gleiche Wahrscheinlichkeit haben, nämlich $\Pr(\omega_i)=\frac{1}{6}\cdot\frac{1}{6}=\frac{1}{36}$. In Abbildung \@ref(fig:prverteilung) links, sehen wir eine Verteilung dieser Wahrscheinlichkeiten; in diesem Fall ist es eine sogenannte _diskrete Gleichverteilung_. Wenn uns das Ereignis "Gesamtaugenzahl" interessiert, hier mit $E$ symbolisiert, gibt es Ergebnisse, die wahrscheinlicher sind als andere (das deckt sich mit unserer Erfahrung mit Würfelspielen). Die Verteilung ist symmetrisch um ein Maximum bei $7$ (Abbildung \@ref(fig:prverteilung) rechts), eine sogenannte _diskrete Dreiecksverteilung_. Formal schreiben wir:
$$\begin{equation}
...
```{r fFempirisch, echo=FALSE, fig.align='center', fig.cap='Links: Empirische **Verteilung** des Merkmals "Entfernung". Der 5. Balken z.B. hat eine Höhe von etwa $0.1$; d.h. rund 10% der Merkmalswerte sind in Klasse 5 (20 - 25km). Rechts: Empirische **Verteilungsfunktion** des Merkmals "Entfernung". Der 5. Balken hat eine Höhe von etwa $0.87$; d.h. rund 87% der Merkmalswerte sind kleiner oder gleich 25km.', fig.show='hold', out.width='50%'}
...
Da unsere Entfernungsdaten rechtsschief verteilt sind - mit relativ kleinen Werten (wenige Kilometer) und relativ großen Werten (Zehner von Kilometern), bietet sich die Lognormalverteilung als theoretische Verteilung an und lässt sich auch gut an die Daten anpassen (vgl. Abbildung \@ref(fig:fFempirisch)).
