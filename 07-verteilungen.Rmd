...
```{r fFempirisch, echo=FALSE, fig.align='center', fig.cap='Links: Empirische **Verteilung** des Merkmals Entfernung. Der 1. Balken z.B. hat eine Höhe von etwa $0.08$; d.h. rund 8% der Merkmalswerte sind in Klasse 1 (0 - 5km). Rechts: Empirische **Verteilungsfunktion** des Merkmals Entfernung. Der 4. Balken hat eine Höhe von etwa $0.86$; d.h. rund 86% der Merkmalswerte sind kleiner oder gleich 20km.', fig.show='hold', out.width='50%'}
...
plot(h, freq = FALSE, col = "gray",
     main = "", ylim = c(0, 0.08), xlab = "Entfernung (km)", ylab = "Dichtefunktion")
