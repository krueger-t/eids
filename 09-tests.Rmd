...
```{r freisezeit2, echo=FALSE, fig.align='center', fig.cap='Histogramme des Merkmals "Reisezeit" der Reisedaten aus dem Wintersemester 2021/22. Die Stichprobe wurde zufällig geteilt. Die vertikalen Linien markieren die Mittelwerte $\\bar x_1=51.2$ (links) und $\\bar x_2=59.4$ (rechts). Die Varianzen sind $s_1^2=478$ und $s_2^2=454$.', fig.show='hold', out.width='50%'}
...
- **Beispiel 6**: Zurück zu den beiden neuen Stichproben aus Beispiel 4 (Abbildung \@ref(fig:freisezeit2)). Ist die Varianz $\sigma_1^2$ (gegeben $s_1^2=478$) größer als die Varianz $\sigma_2^2$ (gegeben $s_2^2=454$)? Beziehungsweise, können wir statistisch nachvollziehen, dass die beiden Stichproben Grundgesamtheiten mit derselben Varianz entstammen? Diese Frage beantwortet der sogenannte **F-Test (rechtsseitig)** (Kapitel \@ref(ftest)).
...
> Sind die mit den Stichprobenmitteln $\bar x_1=51.2$ und $\bar x_2=59.4$ geschätzten Mittelwerte $\mu_1$ und $\mu_2$ ungleich? Beziehungsweise, können wir statistisch nachvollziehen, dass die beiden Stichproben Grundgesamtheiten mit dem selben Mittelwert entstammen?
...
> Der Unterschied der mit den Stichprobenmitteln $\bar x_1$ und $\bar x_2$ geschätzten Mittelwerte $\mu_1$ und $\mu_2$ ist _nicht signifikant_. D.h. wir können statistisch nachweisen, dass die beiden Stichproben Grundgesamtheiten mit dem selben Mittelwert entstammen.
...
> Ist die Varianz $\sigma_1^2$ (gegeben $s_1^2=478$) größer als die Varianz $\sigma_2^2$ (gegeben $s_2^2=454$)? Beziehungsweise, können wir statistisch nachvollziehen, dass die beiden Stichproben Grundgesamtheiten mit derselben Varianz entstammen?
...
> Der Unterschied der beiden Varianzen ist statistisch _nicht signifikant_. D.h. wir konnten nachweisen, dass die beiden Stichproben Grundgesamtheiten mit der selben Varianz entstammen.

Zusammen mit Bsp. 4 konnten wir nun statistisch nachvollziehen, dass die beiden Stichproben der selben Grundgesamtheit entstammen.
...
In der Tat wurden die beiden Teilstichproben ja der gleichen Stichprobe zufällig entnommen.
